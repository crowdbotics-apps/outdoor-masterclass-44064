...
## Project Structure
    ...
    ├── outdoor_masterclass_44064  # Django project configurations
...
1. Clone this repo and `cd outdoor_masterclass_44064`
...
2. Clone this repo and `cd outdoor_masterclass_44064`
